...
import {
  Sheet,
  SheetContent,
  SheetHeader as UiSheetHeader, // Renombrado para evitar conflicto
  SheetTitle,
  SheetDescription
...
>(
  (
    ...
    const mobileSidebarTitleId = React.useId();
    const mobileSidebarDescriptionId = React.useId();
      ...
      return (
        <Sheet open={openMobile} onOpenChange={setOpenMobile}>
          ...
          >
            ...
            <UiSheetHeader> {/* Removed sr-only from here */}
              <SheetTitle id={mobileSidebarTitleId} className="sr-only"> {/* Added sr-only here */}
                Menú de Navegación Principal
              </SheetTitle>
              <SheetDescription id={mobileSidebarDescriptionId} className="sr-only"> {/* Added sr-only here */}
                Contiene los enlaces de navegación principales de la aplicación.
              </SheetDescription>
            </UiSheetHeader>
...
// SidebarHeader sin la lógica de mobileTitleId
...
export {
  ...
  SidebarHeader,
  UiSheetHeader,
  // SidebarInput, // SidebarInput was not defined in the original file
  SidebarInset,
  SidebarMenu,
  SidebarMenuAction,
  SidebarMenuBadge,
